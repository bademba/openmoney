...
import ke.io.openmoney.UserUtils;
...
public class DBConnector {
    ...
    private static final String MYSQL_DB_CONNECTION = "jdbc:mysql://localhost:3306/remittance";
    ...
    private static final String POSTGRES_DB_CONNECTION = "jdbc:postgresql://127.0.0.1:5432/remittence";
    ...
    public void close(Connection conn) {
        try {
            ...
            Logger lgr = Logger.getLogger(UserUtils.class.getName());
